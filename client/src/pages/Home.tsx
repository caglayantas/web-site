...
const projectFallbackTr = [{ slug: "elektrik-enerji", label: "Elektrik ve enerji", title: "Akü ve güç dağıtım sistemi", detail: "Mevcut pano düzeninin okunabilirliği, bağlantı güvenliği ve servis erişimi için planlanan kapsam.", beforeImage: "/manus-storage/perla-service-electrical_bfa1b249_34b9f24d.webp", afterImage: "/manus-storage/perla-service-marine-electronics_a9f3a57f_2b833740.webp" }, { slug: "motor-tahrik", label: "Motor ve tahrik", title: "Şaft ve pervane sistemi", detail: "Motor, şaft, kaplin ve pervane hattında bakım önceliklerini görünür kılan çalışma.", beforeImage: "/manus-storage/perla-service-propulsion_1dad9846.webp", afterImage: "/manus-storage/perla-service-mechanical_1537487f.webp" }, { slug: "mekanik-sistemler", label: "Mekanik sistemler", title: "Yakıt ve sintine hatları", detail: "Pompa, vana, hortum ve erişim noktalarının servis planına alınması.", beforeImage: "/manus-storage/perla-service-mechanical_1537487f.webp", afterImage: "/manus-storage/perla-service-electrical_bfa1b249_34b9f24d.webp" }];
const projectFallbackEn = [{ slug: "elektrik-enerji", label: "Electrical and power", title: "Battery and power distribution system", detail: "Scope planned for panel-layout clarity, connection safety, and service access.", beforeImage: "/manus-storage/perla-service-electrical_bfa1b249_34b9f24d.webp", afterImage: "/manus-storage/perla-service-marine-electronics_a9f3a57f_2b833740.webp" }, { slug: "motor-tahrik", label: "Engine and propulsion", title: "Shaft and propeller system", detail: "Work that makes maintenance priorities visible across the engine, shaft, coupling, and propeller line.", beforeImage: "/manus-storage/perla-service-propulsion_1dad9846.webp", afterImage: "/manus-storage/perla-service-mechanical_1537487f.webp" }, { slug: "mekanik-sistemler", label: "Mechanical systems", title: "Fuel and bilge lines", detail: "Bringing pumps, valves, hoses, and access points into a service plan.", beforeImage: "/manus-storage/perla-service-mechanical_1537487f.webp", afterImage: "/manus-storage/perla-service-electrical_bfa1b249_34b9f24d.webp" }];
  ...
  return (
    <div className="home-page-compact">
        ...
        <section className="section partners-band">
          ...
          <div className="partners-band__grid">
            {localizedPartners.map((partner) => {
              const card = (
                <>
                  {partner.logo && <img className="partners-band__logo" src={partner.logo} alt={`${partner.name} ${t.logoAlt}`} width={220} height={110} loading="lazy" decoding="async" />}
      ...
      <section id="iletisim" className="checkup-cta" aria-labelledby="checkup-title">
        <div className="checkup-cta__image"><img src="/manus-storage/perla-marine-checkup-inspection-report_423e7f5f.jpg" alt={t.checkupImgAlt} width={640} height={480} loading="lazy" decoding="async" /></div>
