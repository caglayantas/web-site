...
const technicalFallback = [{ category: "Elektrik ve enerji sistemleri", title: "Lityum ve akü sistemlerinde bakım kontrolü nerede başlar?", excerpt: "Bağlantı düzeni, şarj davranışı ve servis erişimi üzerinden pratik bir kontrol çerçevesi.", slug: "lityum-ve-aku" }, { category: "Motor, tahrik ve dümen", title: "Motor, şaft ve dümen sistemlerinde bakım işaretleri.", excerpt: "Titreşim, ses, boşluk ve bağlantı değişimlerini erken fark etmek için saha notları.", slug: "motor-saft" }, { category: "Mekanik tesisatlar", title: "Pompa, vana ve hortum hatlarında planlı bakım.", excerpt: "Sızdırmazlık, erişim ve deniz suyu sistemlerinde düzenli kontrolün pratik karşılığı.", slug: "pompa-vana" }];
