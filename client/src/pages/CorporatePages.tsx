...
const pageData: Record<string, PageData> = {
  about: {
    ...
    lead: "Perla Marine; tekne ve yat bakım-onarım, refit ve teknik servis süreçlerini mühendislik disiplini, saha deneyimi ve şeffaf iletişim anlayışıyla yöneten kurumsal bir denizcilik çözüm ortağıdır.",
    image:
      "/manus-storage/perla-about-drydock-inspection_96665f8c.jpg",
    alt: "Kuru havuzda motor yat üzerinde teknik inceleme yapan denizcilik uzmanı",
  },
  ...
  services: {
    ...
    lead: "Kompozit, marin elektrik, elektronik, iklimlendirme, mekanik tesisat, motor-tahrik-dümen ve güverte sistemleri için tekneye özel servis çözümleri.",
    image:
      "/manus-storage/perla-service-composite-v2_b27df9c1.webp",
    alt: "Yat kompozit kalıbı, elyaf malzeme ve teknik üretim ekipmanları",
  },
  ...
  projects: {
    ...
    lead: "Bakım ve refit kapsamını mevcut durum, kullanım profili ve uygulanabilir sonraki adım üzerinden ele alıyoruz.",
    image:
      "/manus-storage/perla-service-propulsion_1dad9846.jpg",
    alt: "Motor ve tahrik sistemi bakım detayı",
  },
  ...
  knowledge: {
    ...
    lead: "Tekne sahipleri ve üretici ekipleri için bakım kararlarını destekleyen teknik notlar, kontrol başlıkları ve uygulama rehberleri.",
    image:
      "/manus-storage/perla-service-marine-electronics_a9f3a57f.jpg",
    alt: "Marin elektronik ve navigasyon ekranları",
  },
  ...
  contact: {
    ...
    lead: "Mevcut durumu, önceliğinizi ve ihtiyaç duyduğunuz zamanı paylaşın; doğru bakım-onarım kapsamını birlikte netleştirelim.",
    image:
      "/manus-storage/perla-service-mechanical_1537487f.jpg",
    alt: "Tekne mekanik tesisat sistemi",
  },
};
...
const projectCards = [
  {
    ...
    before:
      "/manus-storage/perla-service-electrical_bfa1b249.jpg",
    after:
      "/manus-storage/perla-service-marine-electronics_a9f3a57f.jpg",
  },
...
const knowledgeCards = [
  [
    "Marin elektrik ve enerji sistemleri",
  ...
  [
    "Motor, tahrik ve dümen sistemleri",
  ...
  [
    "Mekanik tesisat ve tekne bakım",
    ...
    <PageFrame>
      ...
      >
        <div className="about-copy">
          <p className="eyebrow">Perla Marine kimdir?</p>
          ...
          <p>
            Perla Marine, tekne ve yat sahipleri, kaptanlar,
            işletmeciler ve üretici firmalar için bakım-onarım ve
            teknik servis süreçlerini yöneten kurumsal bir uygulama
            şirketidir. Çalışma alanımız; kompozit imalat ve
            tamirden marin elektrik ve lityum sistemlerine,
            elektronik altyapıdan motor-tahrik-dümen, mekanik
            tesisat ve güverte ekipmanlarına kadar teknenin teknik
            bütününü kapsar.
          </p>

          <p>
            Her operasyonu geçici bir müdahale olarak değil,
            teknenin güvenliğini, kullanılabilirliğini ve uzun
            vadeli işletme değerini destekleyen bir bakım kararı
            olarak ele alırız.
          </p>
        </div>

        <img
          src="/manus-storage/perla-about-technical-planning_01d3402f.jpg"
      ...
      >
        <div className="about-panel about-panel--navy">
          <p className="eyebrow eyebrow--light">Vizyonumuz</p>

          <h2 id="about-vision-title">
            Türkiye’de denizcilik bakımını,{" "}
            <em>standartları olan bir hizmet kültürüne</em> dönüştürmek.
          </h2>

          <p>
            Vizyonumuz; tekne bakımının yalnızca arıza ortaya
            çıktığında hatırlanan bir gider kalemi olmaktan çıkıp,
            planlı işletme ve güvenli seyir kültürünün ayrılmaz bir
            parçası haline gelmesidir. Bunun için teknik bilgiyi
            anlaşılır hale getiriyor, saha uygulamasını ölçülebilir
            bir iş akışıyla buluşturuyoruz. Müşterilerimizin
            kararlarını belirsizlikten uzaklaştıran; kapsamı,
            sorumluluğu ve sonraki adımı açıkça ortaya koyan bir
            bakım anlayışının denizcilik sektöründe kalıcı bir
            standarda dönüşmesini hedefliyoruz.
          </p>
        </div>
        ...
        <div className="about-panel about-panel--ivory">
          ...
          <h2>
            ...
            <em>doğru çözümü doğru kapsamda</em> uygulamak.
          </h2>

          <p>
            Misyonumuz; tekne sahibinin, kaptanın veya üretici
            ekibinin teknik ihtiyacını doğru anlayarak güvenli,
            uygulanabilir ve sürdürülebilir bir bakım-onarım
            çözümüne dönüştürmektir. Planlama, tedarik, uygulama,
            kontrol ve teslim aşamalarını birbirinden koparmadan
            yönetiriz. Her işte müşterimizin teknesini, zamanını ve
            bütçesini koruyan bir sorumlulukla hareket eder; yapılan
            işlemin nedenini, kapsamını ve beklenen sonucunu
            anlaşılır biçimde paylaşırız. Böylece müşterilerimiz
            yalnızca bir servis hizmeti değil, kararlarını güvenle
            verebilecekleri kurumsal bir çalışma zemini elde eder.
          </p>
        </div>
      </section>
      ...
      >
        <div className="section-heading section-heading--split">
          <div>
            <p className="eyebrow">Size ne vaat ediyoruz?</p>

            <h2 id="about-promise-title">
              Daha fazla söz değil,{" "}
              <em>daha net bir çalışma standardı.</em>
            </h2>
          </div>

          <p>
            Kurumsal hizmet anlayışımızın temelinde, işin başında
            verilen söz ile teslim edilen işin aynı kapsamda
            buluşması vardır.
          </p>
        </div>
        ...
        <div className="about-promise-grid">
          <article>
            ...
            <p>
              İhtiyacı, önceliği ve uygulanacak operasyonu anlaşılır
              bir çerçevede tanımlar; kapsam dışı beklentileri
          ...
          <article>
            ...
            <p>
              İş programını, servis erişimini, sistemler arası
              ilişkileri ve kontrol adımlarını sahadaki gerçek
              koşullara göre yönetiriz.
            </p>
          </article>
          ...
          <article>
            ...
            <p>
              Yapılan işlemleri ve önerilen sonraki adımları açıkça
              paylaşır; teknenin bakım geçmişine değer katan bir
              iletişim bırakırız.
            </p>
          </article>
        </div>
      ...
      >
        <div className="about-trust__intro">
          ...
          <p>
            Perla Marine ile çalışmak; teknik ihtiyacın doğru
            sorularla ele alınması, seçeneklerin anlaşılır biçimde
            değerlendirilmesi ve uygulamanın kontrol noktalarıyla
            ilerlemesi anlamına gelir. Her teknenin farklı olduğunu
            kabul eder, her müdahaleyi sistem bütünlüğü içinde
            planlarız.
          </p>
        </div>
        ...
        <div className="about-trust__grid">
          <article>
            ...
            <p>
              Kararlarımızı yalnızca katalog bilgisine değil, tekne
              üzerinde karşılaşılan erişim, kullanım ve bakım
              koşullarına dayandırırız.
            </p>
          </article>
          ...
          <article>
            ...
            <p>
              Kompozit, elektrik, elektronik, mekanik, tahrik ve
              güverte sistemlerini birbirinden bağımsız parçalar
              değil, birlikte çalışan bir yapı olarak
              değerlendiririz.
            </p>
          </article>
          ...
          <article>
            ...
            <p>
              Tekne sahipleri için güvenli bakım, üretici firmalar
              için uygulanabilir teknik koordinasyon ve tüm
              paydaşlar için açık iletişim standardı sunarız.
            </p>
          </article>
          ...
          <article>
            ...
            <p>
              Gerçek kapsamı görmeden kesin sonuç sözü vermek yerine,
              doğru inceleme ve doğru planlamayla güvenilir bir
              sonraki adım öneririz.
            </p>
          </article>
        </div>
      </section>
      ...
      >
        <div>
          ...
          <h2 id="about-references-title">
            ...
            <em>izinli ve doğrulanmış kayıtlarla</em> görünür olur.
          </h2>

          <p>
            Kurumsal referans isimleri ve logoları yalnızca ilgili
            tarafların yazılı kullanım onayı bulunduğunda
            yayınlıyoruz. Bu alan, doğrulama süreci tamamlanan iş
            ortakları ve saha çalışmalarımızla güncellenecek şekilde
            hazırlanmıştır.
          </p>
        </div>

        <div className="reference-disclosure">
          <span>Kurumsal referans alanı</span>

          <strong>Yeni iş birlikleri için açık.</strong>

          <p>
            İşletmeciler, üretici firmalar ve tekne sahipleriyle
            yürütülen çalışmalar; kapsam ve izin bilgileri
            netleştirildikçe burada yer alacaktır.
          </p>
      ...
      >
        <div>
          <p className="eyebrow">Kurumsal doküman</p>
          ...
          <p>
            Perla Marine’in çalışma alanlarını, hizmet başlıklarını,
            iş yapma standardını ve iletişim bilgilerini içeren
            kurumsal PDF profilini indirebilirsiniz.
          </p>
        </div>

        <a
          className="button button--navy"
          href="/manus-storage/main_592e54aa.pdf"
          target="_blank"
          rel="noopener noreferrer"
          download="perla-marine-kurumsal-sirket-profili.pdf"
        >
          PDF profili indir
      ...
      <section className="about-consulting">
        <div>
          <p className="eyebrow">Kurumsal iş ortaklığı</p>
        ...
        <p>
          Tekne ve yat üreticilerine servis erişimi, sistem
          yerleşimi, bakım yapılabilirliği, saha kontrolü, teknik
          dokümantasyon ve uygulama koordinasyonu başlıklarında
          destek sunuyoruz. Her iş ortaklığı, üretim takvimi ve
          teknik sorumluluk sınırları netleştirilerek planlanır.
        </p>
  ...
  return (
    <PageFrame>
      ...
      <section className="corporate-section">
        <div className="section-heading section-heading--split">
          <div>
            <p className="eyebrow">Bakım ve servis kapsamı</p>
          ...
          <p>
            Her hizmet grubunu ayrı bir operasyon olarak ele
            alıyor, gerektiğinde sistemler arası ilişkiyi birlikte
            değerlendiriyoruz.
          </p>
        </div>
  ...
  useEffect(() => {
    const onKeyDown = (event: KeyboardEvent) => {
      ...
      if (event.key === "ArrowRight") {
        setImageIndex((current) => (current + 1) % 2);
      }
...
export function ProjectsNew() {
  ...
  const publishedProjects =
    trpc.projects.published.useQuery();

  const displayProjects = publishedProjects.isError
    ? projectCards
    : (publishedProjects.data ?? []).map(
        (project) => ({
          ...project,
          scope: project.scope ?? "",
  ...
  return (
    <PageFrame>
      ...
      <section className="corporate-section">
        <div className="section-heading section-heading--split">
          <div>
            <p className="eyebrow">Saha çalışmaları</p>
          ...
          <p>
            Bu görsel çiftleri, proje kapsamını anlatmak için
            kullanılan örnek teknik görsellerdir. Onaylı gerçek
            saha fotoğrafları geldikçe ilgili proje kartları
            güncellenecektir.
          </p>
        </div>
            ...
            >
              ...
              <div className="project-detail-card__copy">
                ...
                <div className="project-detail-card__facts">
                  ...
                  <div>
                    <strong>Kullanılan sistemler</strong>
                    <p>{project.systems}</p>
                  </div>

                  <div>
                    <strong>Bakım sonucu</strong>
                    <p>{project.results}</p>
                  </div>
                </div>
...
export function KnowledgeNew() {
  ...
  const posts =
    trpc.knowledge.published.useQuery();

  const displayPosts = posts.isError
    ? knowledgeCards.map(
        ([category, title, excerpt], index) => ({
          id: index,
          slug: title
            .slice(0, 24)
            .toLowerCase()
          ...
          title,
          excerpt,
          coverImage: getKnowledgeCoverImage(
            category,
            title
          ),
          body: `> ${excerpt}`,
  ...
  return (
    <PageFrame>
      <PageHero data={pageData.knowledge} />
        ...
        <div className="section-heading section-heading--split">
          <div>
            ...
            <h2>
              ...
              <br />
              <em>kısa ve net rehberler.</em>
            </h2>
          </div>

          <p>
            Teknik Bilgiler; yalnızca yayınlanmış, doğrudan bakım
            kararlarını destekleyen yazılardan oluşan sade bir
            içerik arşividir. Her yazının kendi adresi, kapak
            görseli ve okunabilir teknik gövdesi bulunur.
          </p>
        </div>
          ...
          {displayPosts.map((post) => (
            ...
            >
              ...
              <details className="knowledge-card__details">
                <summary>Kısa önizleme</summary>

                <div
                  className="knowledge-card__body"
                  dangerouslySetInnerHTML={{
                    __html: renderKnowledgeBody(
                      post.body
                    ),
                  }}
                />
...
export type CorporateContactErrors =
  Partial<FormState> & {
    consent?: string;
  };
...
export function validateCorporateContact(
  ...
  if (!values.name.trim()) {
    next.name = "Ad soyad alanını doldurun.";
  }
...
export function ContactNew() {
  ...
  async function handleSubmit(
    ...
    /*
     * Honeypot alanı doluysa bunu bot kabul ediyoruz.
